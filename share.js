...
window.fsShareCopy=function(btn){
...
function makeBtns(){
  var copyBtn='<button class="shr-btn" onclick="fsShareCopy(this)"><i class="fa-solid fa-link" style="font-size:11px"></i> Copy link</button>';
